      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <h4 className="text-xs font-mono-data uppercase tracking-widest text-slate-200 font-bold">
              CAD Portals
            </h4>
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className="space-y-2 text-sm font-mono-data">
              <li>
                <a href="tel:113" className="text-slate-300 hover:text-blue-400 transition-colors flex items-center justify-between gap-3 p-1 rounded hover:bg-slate-900/40">
                  <span>113 - Police</span>
                  <span className="text-xs text-blue-400 font-bold shrink-0">Cảnh Sát</span>
                </a>
              </li>
              <li>
                <a href="tel:114" className="text-slate-300 hover:text-red-400 transition-colors flex items-center justify-between gap-3 p-1 rounded hover:bg-slate-900/40">
                  <span>114 - Fire &amp; Rescue</span>
                  <span className="text-xs text-red-400 font-bold shrink-0">Cứu Hỏa</span>
                </a>
              </li>
              <li>
                <a href="tel:115" className="text-slate-300 hover:text-emerald-400 transition-colors flex items-center justify-between gap-3 p-1 rounded hover:bg-slate-900/40">
                  <span>115 - Medical EMS</span>
                  <span className="text-xs text-emerald-400 font-bold shrink-0">Cấp Cứu</span>
                </a>
              </li>
              <li>
                <a href="tel:111" className="text-slate-300 hover:text-purple-400 transition-colors flex items-center justify-between gap-3 p-1 rounded hover:bg-slate-900/40">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="space-y-2.5 text-xs text-slate-400 font-mono-data">
              <div className="p-3 rounded-lg bg-slate-900 border border-slate-800 flex items-center gap-2.5">
                ...
                <span>GovTech CAD Level 4 Standards Compliant</span>
              </div>
              <div className="p-3 rounded-lg bg-slate-900 border border-slate-800 flex items-center gap-2.5">
                <Lock className="w-4 h-4 text-blue-400 shrink-0" />
                <span>Zero-Trust End-to-End Encryption (AES-256)</span>
              </div>
            </div>
          </div>
