      ...
      <aside className="fixed top-0 right-0 h-full w-full max-w-md bg-[#0B0F19] border-l border-slate-800 z-[1401] flex flex-col shadow-2xl shadow-black/60 animate-drawer-in">
        <div className="shrink-0 flex items-center justify-between px-5 py-4 border-b border-slate-800">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-9 h-9 rounded-lg bg-blue-600/15 border border-blue-800/60 flex items-center justify-center shrink-0">
              <TypeIcon className="w-5 h-5 text-blue-400" />
            </div>
            <div className="min-w-0">
              <h2 className="text-base font-bold text-white font-mono-data truncate">{vehicle.plate}</h2>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-4 space-y-3">
            <div className="flex items-center gap-2 text-xs font-mono-data uppercase tracking-wider text-slate-400 font-bold">
